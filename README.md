...
mac[i] = key[i % key_len] ^ message[i % msg_len]; // Simple XOR 
operation 
} 
...
## Output:
<img width="744" height="242" alt="image" src="https://github.com/user-attachments/assets/512b9983-c578-41f2-9109-6c26b1b14e54" />
